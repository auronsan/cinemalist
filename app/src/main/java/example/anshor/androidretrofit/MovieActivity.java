package example.anshor.androidretrofit;
...
import example.anshor.androidretrofit.adapter.MovieListAdapter;
import example.anshor.androidretrofit.listener.RecyclerViewItemClickListener;
import example.anshor.androidretrofit.model.CityData;
import example.anshor.androidretrofit.model.Movie;
import example.anshor.androidretrofit.service.ApiService;
import example.anshor.androidretrofit.util.DividerItemDecoration;
import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

/**
 * Created by anshor on 7/20/16.
 */
